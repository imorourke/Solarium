...
\author{Ian O'Rourke}
\date{v0.2.2 \\ \titlelogoimage \today}
...
When in kernel mode functions, structures, variables, and constants that do not start with an underscore (\texttt{\_}) can be exported into a header file providing the definition and location. This allows common code to be shared between multiple applications.
