...
Application binary files are written in a way that would allow external functions to be linked into the program. The basic format is specified below in Table \ref{table:cbuoy-exec-header}, providing a magic number to identify the application and offsets and sizes for both the link and application data regions.
