...
Another useful tool is \texttt{Jib/Term}, which provides a text-based version of \texttt{Visual/Jib}, albeit without the helpful diagnostic tools and built-in samples. It will boot and allow execution of the Cb/OS operating system.
