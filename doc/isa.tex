...
\begin{table}[h!]
    ...
    \begin{tabular}{c|cc|l}
        ...
        4 & \texttt{u32} & \texttt{link\_offset} & Link region offset from base of binary file \\
        8 & \texttt{u32} & \texttt{link\_size} & Link region size \\
        12 & \texttt{u32} & \texttt{data\_offset} & Executable region offset from base of binary file \\
	16 & \texttt{u32} & \texttt{data\_size} & Executable region size \\
        \hline
    \end{tabular}
...
If there is a link region, this will consist of an array of link structures, found in Table \ref{table:cbuoy-exec-link}, to define how to link functions and variables into the application. This will provide the name of each symbol and the offset within the executable data region with which to write the corresponding address into.
...
\begin{table}[h!]
    ...
    \begin{tabular}{c|cc|l}
        ...
        2 & \texttt{[symbol\_size]u8} & \texttt{symbol\_name} & Symbol string, null-terminated \\
        \hline
    \end{tabular}
