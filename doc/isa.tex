...
Input arguments are provided as arguments into \texttt{main}. These include program state information, and then traditional arguments for the command line input values and number of command line arguments. The first argument is the program name. This is shown in an example for the \texttt{cat} program implementation in Listing \ref{listing:cbuoy-bin-cat} and the \texttt{echo} program implementation in Listing \ref{listing:cbuoy-bin-echo}.
